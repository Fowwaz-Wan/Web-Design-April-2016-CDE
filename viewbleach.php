...
if(isset($_SESSION['userSession'])=="")
    ...
    if(isset($_SESSION['userSession']))
        {
           $query = "SELECT Title,Review,Comment,username,c_id FROM manga WHERE c_id = $c_id;";
           $result = $MySQLi_CON->query($query);
               ...
               $row1 ="0";
                 ...
                 print '<form action="viewbleach.php" method="post" onsubmit="return checkForm(this);">'
                .'<table align="center">'
                .'<tr>'
                    .'<td><img src="BleachCover.jpg" style="width: 200px;height: 300px"></td>';
